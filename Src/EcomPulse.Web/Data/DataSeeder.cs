...
public class DataSeeder
{
    ...
    public async Task CreateCartAndOrderAsync()
    {
        ...
        if (user == null) throw new ArgumentNullException(nameof(user), "User with the specified ID does not exist.");
        ...
        try
        {
            ...
            if (product == null) throw new InvalidOperationException("No products available to add to the cart.");
            var cart = new Cart
            {
                Id = Guid.NewGuid(),
                UserId = user.Id,
