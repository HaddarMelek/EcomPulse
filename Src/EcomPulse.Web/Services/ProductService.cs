...
public class ProductService
{
    ...
    public async Task<bool> CreateProductAsync(string name, string description, decimal price, string? imageUrl,
    ...
    public async Task UpdateProductAsync(Guid id, string name, string description, decimal price, string? imageUrl,
        Guid categoryId, string? categoryName, CancellationToken cancellationToken = default)
    {
        try
        {
